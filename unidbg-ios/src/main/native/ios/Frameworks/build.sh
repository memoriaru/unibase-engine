...
function build_UIKit() {
  xcrun -sdk iphoneos clang -o "$1"/"$1" "$1"/"$1".m UIKit/CFNetwork.m UIKit/new_symbol.mm -shared -lstdc++ -lobjc -m32 -arch armv7 -miphoneos-version-min=7.1 -framework "$2" \
...
build_framework PDFKit "Foundation"
build_framework ContactsUI "Foundation"
build_framework CoreAudioKit "Foundation"
build_framework GameplayKit "Foundation"
build_framework CoreBluetooth "Foundation"
build_framework Social "Foundation"
build_framework HealthKitUI "Foundation"
build_framework iAd "Foundation"
build_framework CallKit "Foundation"
build_framework Intents "Foundation"
build_framework NotificationCenter "Foundation"
build_framework WatchConnectivity "Foundation"
